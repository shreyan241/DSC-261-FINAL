...
train <- read.csv(file="../Data/shap_cc_RBF_train.csv")
...
write.csv(generated, file = "../Data/shap_cc_RBF.csv", row.names = FALSE)

# Generate data for training of the adversarial model
generated <- newdata(generator, size = 100)
# Remove the response column
generated <- generated[, -ncol(generated)]
write.csv(generated, file = "../Data/shap_cc_adversarial_train_RBF.csv", row.names = FALSE)
...
write.csv(forestGenerated, file = "../Data/shap_cc_forest.csv", row.names = FALSE)

# Generate data for training of the adversarial model
forestGenerated <- newdata(forestGenerator, size = 100)
# Remove the response column
forestGenerated <- forestGenerated[, -ncol(forestGenerated)]
write.csv(forestGenerated, file = "../Data/shap_cc_adversarial_train_forest.csv", row.names = FALSE)
